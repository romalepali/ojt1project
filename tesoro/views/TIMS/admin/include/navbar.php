	...
	<div class="custom-nav">
		<div style="float: right; color: white;">
			<button type="button" class="btn btn-danger notify" data-toggle="dropdown">
				<img style="margin-top: -14px; margin-left: -15px; position: absolute;border-radius: 100px; width: 30px; height: 30px;" src="../users/images/<?php echo $user['picture'].".png";?>">
			</button>
		...
		<div style="float: right; color: white;">
			<button type="button" class="btn btn-danger notify jobbings-due" title="Due Dates" data-toggle="dropdown">
				<img style="margin-top: -13px; margin-left: -15px; position: absolute; width: 30px; height: 30px;" src="images/due.png">
